...
export default function InfiniteCategoryVideoList({ categoryType, categoryName, order, title, showFilter = true }: InfiniteCategoryVideoListProps) {
  ...
  }, [currentPage, totalPages, order, loadingMore, categoryType, categoryName, showLoadMoreButton, loadCategories])
  ...
  }, [currentPage, totalPages, order, loadingMore, categoryType, categoryName, router, pathname])
